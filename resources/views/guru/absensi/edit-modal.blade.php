...
<div class="modal fade" id="modalEditAbsensiGuru{{ $absensi->id }}" tabindex="-1" aria-labelledby="modalEditAbsensiGuruLabel{{ $absensi->id }}" aria-hidden="true">
        ...
        <div class="modal-body overflow-y-auto max-h-[70vh]">
          <div class="space-y-4">
            <div>
              ...
              <input type="text" value="{{ $absensi->guru->nama ?? 'N/A' }}" class="form-input mt-1 block w-full rounded-lg border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-600 text-gray-900 dark:text-white" readonly>
              <small class="text-gray-500">Nama guru tidak dapat diubah</small>
            </div>
            <div>
