...
@section('page_class', 'page-guru-jadwal')
@section('content')
    ...
    <div class="container-fluid px-4 py-8 mt-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mt-1">Kelola jadwal mengajar dan aktivitas kelas Anda</p>
                    </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/20 border border-gray-200 dark:border-gray-700 overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl">
            ...
            <div class="overflow-x-auto">
                <table id="tableJadwalGuru" class="w-full text-sm">
                        ...
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left font-semibold text-gray-900 dark:text-white">
                                <span class="flex items-center">
                                    <i data-lucide="calendar-days" class="w-4 h-4 text-green-500 dark:text-green-400 mr-1"></i>
                                    Hari
                                </span>
                            </th>
                            <th class="px-4 py-3 text-left font-semibold text-gray-900 dark:text-white">
                            ...
                            <th class="px-4 py-3 text-left font-semibold text-gray-900 dark:text-white">
                                <span class="flex items-center">
                                    <i data-lucide="school" class="w-4 h-4 text-indigo-500 dark:text-indigo-400 mr-1"></i>
                                    Kelas
                                </span>
                            </th>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center">
                                    <div class="w-8 h-8 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center mr-3">
                                        <i data-lucide="calendar-days" class="w-4 h-4 text-green-600 dark:text-green-400"></i>
                                    </div>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center">
                                    <div class="w-8 h-8 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg flex items-center justify-center mr-3">
                                        <i data-lucide="school" class="w-4 h-4 text-indigo-600 dark:text-indigo-400"></i>
                                    </div>
                        ...
                        <tr class="bg-white dark:bg-gray-800">
                            <td colspan="6" class="px-4 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-500 dark:text-gray-400 font-medium">Belum ada jadwal mengajar</p>
                                    <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">Jadwal mengajar akan muncul setelah admin menambahkan jadwal untuk Anda</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
