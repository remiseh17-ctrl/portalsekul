...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    <div class="container-fluid px-4 py-8 mt-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mt-1">Input nilai siswa secara batch untuk efisiensi</p>
                    </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/20 border border-gray-200 dark:border-gray-700 overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl mb-6">
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4">
                <div class="flex items-center">
                    ...
                    <h5 class="text-lg font-bold">Informasi Input Nilai</h5>
                </div>
            </div>
            <div class="p-6">
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <h5 class="text-lg font-bold">Tabel Input Nilai Siswa</h5>
                    </div>
                                    ...
                                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200">
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="space-y-2">
                                                <div class="relative">
                                                    <input type="number"
                                                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all text-center font-semibold"
                                                        name="nilai[{{ $siswa->id }}]"
                                                        value="{{ $currentNilai }}"
                                                        min="0"
                                                        max="100"
                                        ...
                                        <td class="px-4 py-4 text-center">
                                            ...
                                            @else
                                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-green-100 dark:bg-green-900/50 text-green-800 dark:text-green-200 border border-green-200 dark:border-green-800">
                            ...
                            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                <div class="text-gray-600 dark:text-gray-300">
                                    <small class="flex items-center">
                                        ...
                                        Gunakan <strong class="text-indigo-600 dark:text-indigo-400">updateOrCreate</strong> untuk efisiensi data
                                    </small>
                                </div>
                                <div class="flex gap-3">
                                    <button type="button" onclick="clearAllNilai()"
                                            class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-gray-500 to-gray-600 text-white rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 font-medium">
                                        <i data-lucide="eraser" class="w-4 h-4"></i>
                                        <span>Clear All</span>
                                    </button>
                                    <button type="submit"
                                            class="inline-flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 font-medium">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/20 border border-gray-200 dark:border-gray-700 overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl mt-6">
            <div class="bg-gradient-to-r from-yellow-500 to-orange-600 text-white px-6 py-4">
                <div class="flex items-center">
                    <i data-lucide="lightbulb" class="w-6 h-6 mr-3"></i>
                    <h5 class="text-lg font-bold">Tips Input Nilai</h5>
                </div>
            </div>
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-3">
                        ...
                        <ul class="space-y-2 text-gray-600 dark:text-gray-300">
                            ...
                            <li class="flex items-center">
                                <i data-lucide="arrow-right" class="w-4 h-4 mr-2 text-blue-500"></i>
                                Kosongkan field untuk tidak mengubah nilai
                            </li>
                        </ul>
                    </div>
                    <div class="space-y-3">
                        ...
                        <ul class="space-y-2 text-gray-600 dark:text-gray-300">
                            <li class="flex items-center">
                                <i data-lucide="arrow-right" class="w-4 h-4 mr-2 text-purple-500"></i>
                                Input semua nilai sekaligus
                            </li>
                            <li class="flex items-center">
                                <i data-lucide="arrow-right" class="w-4 h-4 mr-2 text-purple-500"></i>
